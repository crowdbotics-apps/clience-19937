"""clience_19937 URL Configuration
...
admin.site.site_header = "Clience"
admin.site.site_title = "Clience Admin Portal"
admin.site.index_title = "Clience Admin"

# swagger
api_info = openapi.Info(
    title="Clience API",
    default_version="v1",
    description="API documentation for Clience App",
)
